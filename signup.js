...
function vform(){
    ...
    var mob=document.getElementById("tel1").value;
    var phoneNumberString1=mob;
    ...
    if(mob.length >= 10){
       ...
       function formatPhoneNumber(phoneNumberString) {
          ...
          var h= match[1] + match[2] + match[3];
          return h;
          }
      
         fr=formatPhoneNumber(phoneNumberString1);
         let regfr=/^[789]\d{9}$/
         ...
         if(regfr.test(fr)){
           ...
           document.getElementById("lb3").innerHTML='Enter Phone number';
           status=0;
           }
          else{
            document.getElementById("lb3").style.color="red";
